...
const crudData_query_1 = __importDefault(require("./crudData.query"));
const postData = (req, res) => {
    ...
    crudData_query_1.default.postDataQueries(postDataParams)
        .then((data) => {
...
const readAllData = (req, res) => {
    const { apiKey, collectionName } = req.params;
    crudData_query_1.default.readAllDataQueries({ apiKey, collection_name: collectionName })
        .then((data) => {
...
const readOneData = (req, res) => {
    ...
    crudData_query_1.default.readOneDataQueries({ apiKey, collection_name: collectionName, document_id: documentId })
        .then((data) => {
        return res.status(data.statusCode).json(data);
    })
        .catch((err) => {
...
const updateOneData = (req, res) => {
    ...
    crudData_query_1.default.updateOneDataQueries({ apiKey, collection_name: collectionName, document_id: documentId, data })
        .then((data) => {
        console.log;
...
const deleteOneData = (req, res) => {
    const { apiKey, collectionName, documentId } = req.params;
    crudData_query_1.default.deleteOneDataQueries({ apiKey, collection_name: collectionName, document_id: documentId })
        .then((data) => {
        return res.status(201).json(data);
    })
        .catch((err) => {
