...
exports.changePassword = exports.resetPassword = exports.confirmEmail = exports.sendAnEmail = void 0;
...
const resetPassword = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        (0, sendEmail_1.default)(email, `http://localhost:8080/changePassword/${token}`, "reset your password")
            .then(res => {
